  ...
  return (
    <div className="letters-container">
      <Flipper
        ...
        stagger
        flipKey={props.circles.join("")}
        onClick={handleRequiredClick}
        className="circle circle--required"
        spring={"stiff"}
        ...
        {props.circles.map((letter, index, arr) => {
          ...
          if (index !== 0)
            return (
              <Flipped
                onAppear={elementIn}
                onExit={elementOut}
                flipId={`${letter}${props.id}`}
                key={`${letter}${props.id}`}
              >
                <div
                  onClick={(e) => handleOptionalClick(e)}
                  key={letter}
                  style={styles}
          ...
          return (
            <Flipped
              ...
              onAppear={elementIn}
              onExit={elementOut}
              flipId={`${letter}--required`}
              key={letter}
            >
              <div className="required-letter" onClick={handleRequiredClick}>
                {letter}
              </div>
            </Flipped>
          );
