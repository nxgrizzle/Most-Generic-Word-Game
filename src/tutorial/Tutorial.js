...
export default function Tutorial(props) {
    ...
    const style={
        ...
        transform: "translate(-50%, -50%)", background:"white", width:"25rem", height:"30rem"}
    }
    // give this a button somewhere, like Help.
  return (
    <>
    <div onClick={()=>setModal(true)} style={{marginLeft:"0.5rem"}}><FontAwesomeIcon icon={faCircleQuestion} size="2xl" className='fa-icon'/></div>
    <Modal appElement={document.getElementById("root") || undefined} closeTimeoutMS={200} style={style} isOpen={modal} onRequestClose={handleClose} shouldCloseOnOverlayClick={props.modal.overlayClick} shouldCloseOnEsc={props.modal.escClick}>
        <div style={{width:"100%",height:"100%"}}>
          <h2>How to Play The Generic Word Game</h2>
          
          <h3 style={{marginTop:"1rem"}}>Create words using letters from the hive.</h3>
          <ul style={{marginTop:"1rem", marginLeft:"1.5rem", marginBottom:"1rem"}}>
            ...
            <li>A pangram is a word that uses every letter in the puzzle. These are worth 10 extra points!</li>
          </ul>
